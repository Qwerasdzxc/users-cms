package raf.lukap.machines.bootstrap;
...
import raf.lukap.machines.repositories.*;
...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        permissions.setCanCreateMachines(true);
        permissions.setCanDestroyMachines(true);
        permissions.setCanSearchMachines(true);
        permissions.setCanRestartMachines(true);
        permissions.setCanStartMachines(true);
        permissions.setCanStopMachines(true);
